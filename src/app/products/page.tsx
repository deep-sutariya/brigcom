...
export default function Home() {
  return (
    <main>
      ...
      <div className="flex items-center justify-center gap-x-10 py-4 px-28 my-20">
        <ProductCard imageUrl="/4.jpg" title="Ayurveda / Natural Herbs" link="/products/ayurvedaandherbs" className="w-2/6" />
