  ...
  return (
    ...
    >
      {type == "productType" ? (
        ...
        <div className=" flex items-center justify-center text-center gap-x-4 border py-8 px-8 rounded-t-lg font-main text-sm bg-gradient-to-b from-black/5 to-transparent hover:bg-gradient-to-t hover:from-black/5 hover:to-gray-100/50">
